...
namespace smssdk\lib\Core\Profile;
use smssdk\lib\Core\Auth\Credential;
use smssdk\lib\Core\Auth\ShaHmac1Signer;
use smssdk\lib\Core\Regions\Endpoint;
use smssdk\lib\Core\Regions\EndpointProvider;
use smssdk\lib\Core\Regions\ProductDomain;
